...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'identifiant.libelle.vide' => 'Ne peut pas être vide',
    'identifiant.libelle.min' => 'Taille min : {{ limit }} caractères',
    'identifiant.libelle.max' => 'Taille max : {{ limit }} caractères',
  ),
  'security' => 
  array (
  ...
  array (
    ...
    'connexion.form.label.code' => 'Code',
    'connexion.form.label.pass' => 'Mot de passe',
    'connexion.form.label.submit' => 'Valider',
    'accueil.titre' => 'Accueil',
    'accueil.lien.title.identifiants' => 'Identifiants',
    'identifiants.titre' => 'Identifiants',
    'identifiants.lien.ajouter' => 'Ajouter un identifiant',
    'identifiants.lien.modifier' => 'Modifier cet identifiant',
    'identifiants.lien.supprimer' => 'Supprimer cet identifiant',
    'identifiants.table.contenu' => 'Contenu',
    'identifiants.table.libelle' => 'Libellé',
    'identifiants.table.actions' => 'Actions',
    'identifiant.titre.ajouter' => 'Ajouter un identifiant',
    'identifiant.titre.modifier' => 'Modifier un identifiant',
    'identifiant.message.ajouter' => 'L\'identifiant a été créé',
    'identifiant.message.modifier' => 'L\'identifiant a été modifié',
    'identifiant.message.supprimer' => 'L\'identifiant a été supprimé',
    'identifiant.label.contenu' => 'Contenu',
    'identifiant.label.libelle' => 'Libellé',
    'identifiant.label.valider' => 'Valider',
    'app.copyright' => 'Ce produit a été conçu par Nicolas DEWEZ - Tous droits réservés',
    'app.description' => 'Application de stockage des informations d\'identification',
    'app.keywords' => 'password, key',
    'app.menu' => 'Menu',
    'app.deconnexion' => 'Se déconnecter',
    'app.retour' => 'Retour',
    'app.confirmsupp' => 'Supprimer cet élément ?',
    'app.message.incorrect' => 'Accès incorrect',
  ),
));
